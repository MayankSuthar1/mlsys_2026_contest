...
def _moe_gemm2_kernel(
    ...
    for ib in range(NUM_I_BLOCKS):
        ...
        # Mixed-precision tensor core path: BF16 activations x FP8 weights.
        o_acc += tl.dot(c_bf16, tl.trans(w2_fp8), out_dtype=tl.float32) * sW2
